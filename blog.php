...
<div class="blog<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="http://schema.org/Blog">
    <?php
    // V. is override enabled?
    /*
       echo "<h1>This is an override!</h1>";
    if ( $this->pageclass_sfx == 'subcats' )
    {
	echo "<h2>And it is a subcats page</h2>";
    }
    else {
	echo "<h2>But this is NOT a subcats page</h2>";
    }
     */
    //V. end is override enabled?
    ?>
	...
	<?php if (!empty($this->intro_items)) : ?>
		...
		<?php endif; ?>
			...
			<?php endif; ?>
	    <?php endforeach; ?>
	    </div> <!-- Last accordion end -->
	<?php endif; ?>
	//V. End display subcategoriy titles in blog listings
